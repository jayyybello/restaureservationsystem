        ...
        <?php if (check_permission('admin')): ?>
            <form action="admin.php" method="post">
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <a href="archive_table.php" class="btn btn-danger ms-2">
                        <i class="fas fa-archive me-1"></i> Archive Tables
                    </a>
                </div>
            </form>
        <?php else: ?>
                             ...
                             <div class="row align-items-center">
                                 <div class="col-md-8">
                                     <div class="d-flex align-items-center mb-1">
                                         <strong>Table ID: <?php echo htmlspecialchars($table['id']); ?></strong>
                                         (Physical ID: <?php echo htmlspecialchars($table['physical_table_id']); ?>)
                                     </div>
                                      ...
                                      <p class="mb-0"><small>
                                           Availability: <span class="badge bg-<?php 
                                               echo $table['availability'] === 'available' ? 'success' : 
                                                   ($table['availability'] === 'taken' ? 'warning' : 'danger'); 
                                           ?>"><?php echo htmlspecialchars(ucfirst($table['availability'])); ?></span>
                                      </small></p>
                                 </div>
                                 <div class="col-md-4 text-end">
                                     ...
                                     <?php if (check_permission('admin')): ?>
                                         <form action="admin.php" method="post" class="d-inline delete-table-form">
